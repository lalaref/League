      ...
      return '<div style="display:grid;grid-template-columns:1fr;gap:20px">'
        + ['Clutch', 'Fastbreak'].map(function (division) {
          ...
          return '<div style="overflow:hidden;background:#fff;border:1px solid #e5e7eb;border-top:4px solid ' + accent + ';border-radius:10px;box-shadow:0 4px 18px rgba(0,0,0,.08)">'
            + '<div style="display:flex;align-items:center;justify-content:space-between;gap:12px;padding:12px 14px;background:' + headerBackground + ';color:#fff">'
            + '<h4 style="margin:0;font-family:\'Raleway\',sans-serif;font-size:13px;font-weight:900;letter-spacing:.1em;text-shadow:0 1px 2px rgba(0,0,0,.2)">DIVISION ' + escapeHtml(division.toUpperCase()) + '</h4>'
            + '<span style="font-size:10px;font-weight:700;color:rgba(255,255,255,.9)">' + rows.length + ' TEAMS</span></div>'
